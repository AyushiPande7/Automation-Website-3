              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
                ...
                <div className="bg-white rounded-2xl p-4 border border-gray-100">
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart
                      data={[{ name: 'Hours Saved', value: stats?.impact?.totalHours || 0 }]}
                    >
                      <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e2e8f0" />
                      ...
                      />
                      <Bar dataKey="value" fill="#EB0A1E" radius={[10, 10, 0, 0]} barSize={70} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
                ...
                <div className="bg-white rounded-2xl p-4 border border-gray-100">
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart
                      data={[{ name: 'Cost Saved', value: stats?.impact?.totalCost || 0 }]}
                    >
                      <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e2e8f0" />
                      <XAxis dataKey="name" axisLine={false} tickLine={false} />
                      <YAxis axisLine={false} tickLine={false} />
                      ...
                      />
                      <Bar dataKey="value" fill="#10B981" radius={[10, 10, 0, 0]} barSize={70} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
