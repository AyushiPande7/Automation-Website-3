...
const categoryColors = {
  ...
  'Software engineering':{ bg: 'bg-indigo-50', text: 'text-indigo-600', border: 'border-l-indigo-500' },
  'Testing and deployment': { bg: 'bg-amber-50', text: 'text-amber-600', border: 'border-l-amber-500' },
